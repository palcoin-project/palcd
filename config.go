...
import (
	...
	_ "github.com/palcoin-project/palcd/database/ffldb"
	"github.com/palcoin-project/palcd/mempool"
	"github.com/palcoin-project/palcd/peer"
	"github.com/palcoin-project/palcutil"
)

const (
	defaultConfigFilename        = "palcd.conf"
	defaultDataDirname           = "data"
	defaultLogLevel              = "info"
	defaultLogDirname            = "logs"
	defaultLogFilename           = "palcd.log"
	defaultMaxPeers              = 125
	...
	sampleConfigFilename         = "sample-palcd.conf"
	defaultTxIndex               = false
	defaultAddrIndex             = false
)

var (
	defaultHomeDir     = palcutil.AppDataDir("palcd", false)
...
// config defines the configuration options for palcd.
//
...
type config struct {
	...
	Listeners            []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 1948, testnet: 11948)"`
	...
	RPCListeners         []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 1967, testnet: 11967)"`
...
func loadConfig() (*config, []string, error) {
	...
	cfg.minRelayTxFee, err = palcutil.NewAmount(cfg.MinRelayTxFee)
	if err != nil {
	...
	cfg.miningAddrs = make([]palcutil.Address, 0, len(cfg.MiningAddrs))
	for _, strAddr := range cfg.MiningAddrs {
		addr, err := palcutil.DecodeAddress(strAddr, activeNetParams.Params)
		if err != nil {
...
// createDefaultConfig copies the file sample-palcd.conf to the given destination path,
