...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in PALC as the value",
	...
	"scriptpubkeyresult-addresses": "The palcoin addresses associated with this script",

	// Vout help.
	"vout-value":        "The amount in PALC",
	...
	"decodescriptresult-addresses": "The palcoin addresses associated with this script",
	...
	"getcurrentnet--synopsis": "Get palcoin network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in PALC/KB",
	...
	"infowalletresult-balance":         "The total palcoin balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in PALC/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in PALC/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in palcoin",
	...
	"gettxoutresult-value":         "The transaction amount in PALC",
	...
	"searchrawtransactions-address":     "The Palcoin address to search for",
	...
	"sendrawtransaction-feesetting":   "Whether or not to allow insanely high fees in bitcoind < v0.19.0 or the max fee rate for bitcoind v0.19.0 and later (palcd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown palcd.",
	"stop--result0":  "The string 'palcd stopping.'",
	...
	"validateaddresschainresult-address":         "The palcoin address (only when isvalid is true)",
	...
	"validateaddress-address":   "Palcoin address to validate",
	...
	"verifymessage-address":   "The palcoin address to use for the signature",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this palcd instance) and when such a transaction first appears in a newly-attached block.",
