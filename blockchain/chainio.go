...
func (b *BlockChain) FetchSpendJournal(targetBlock *palcutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *palcutil.Block) ([]SpentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := palcutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err = b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(palcutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a palcutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*palcutil.Block, error) {
	...
	block, err := palcutil.NewBlockFromBytes(blockBytes)
	if err != nil {
		return nil, err
	}
...
func dbStoreBlock(dbTx database.Tx, block *palcutil.Block) error {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*palcutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*palcutil.Block, error) {
