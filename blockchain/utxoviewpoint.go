...
func (view *UtxoViewpoint) AddTxOut(tx *palcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *palcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *palcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *palcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *palcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *palcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *palcutil.Tx) (*UtxoViewpoint, error) {
