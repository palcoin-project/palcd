...
func GetBlockWeight(blk *palcutil.Block) int64 {
...
func GetTransactionWeight(tx *palcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *palcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
