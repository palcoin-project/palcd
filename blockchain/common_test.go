...
// palcutil.Block.  This is largely borrowed from the test code in btcdb.
func loadBlocks(filename string) (blocks []*palcutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = palcutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
