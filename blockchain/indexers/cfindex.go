...
import (
	...
	"github.com/palcoin-project/palcutil/gcs"
...
func storeFilter(dbTx database.Tx, block *palcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *palcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *palcutil.Block,
