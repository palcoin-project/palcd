...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*palcutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *palcutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *palcutil.Block) error {
