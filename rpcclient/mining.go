...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address palcutil.Address, maxTries *int64) FutureGenerateToAddressResult {
...
func (c *Client) GenerateToAddress(numBlocks int64, address palcutil.Address, maxTries *int64) ([]*chainhash.Hash, error) {
...
func (c *Client) SubmitBlockAsync(block *palcutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *palcutil.Block, options *btcjson.SubmitBlockOptions) error {
