...
import (
	...
	peerpkg "github.com/palcoin-project/palcd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*palcutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *palcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *palcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *palcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
