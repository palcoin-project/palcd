...
func newConfig(prefix, certFile, keyFile string, extra []string,
	...
	a := &nodeConfig{
		listen:    "127.0.0.1:11917", //18555",
		rpcListen: "127.0.0.1:11918", //18556",
		rpcUser:   "user",
		rpcPass:   "pass",
		extra:     extra,
		prefix:    prefix,
...
// as the base for the log and data directories for palcd.
...
func genCertPair(certFile, keyFile string) error {
	...
	cert, key, err := palcutil.NewTLSCertPair(org, validUntil, nil)
	if err != nil {
		return err
	}
