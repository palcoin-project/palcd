...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr palcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*palcutil.Tx, error) {
...
func CreateBlock(prevBlock *palcutil.Block, inclusionTxs []*palcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr palcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*palcutil.Block, error) {
	...
	blockTxns := []*palcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := palcutil.NewBlock(&block)
