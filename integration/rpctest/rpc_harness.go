...
// platform for creating rpc driven integration tests involving palcd. The
...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*palcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []palcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (palcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() palcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*palcutil.Tx, blockVersion int32,
	blockTime time.Time) (*palcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*palcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*palcutil.Block, error) {
	...
	prevBlock := palcutil.NewBlock(mBlock)
...
func baseDir() (string, error) {
	dirPath := filepath.Join(os.TempDir(), "palcd", "rpctest")
