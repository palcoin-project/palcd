...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*palcutil.Block, error) {
	...
	blocks := make([]*palcutil.Block, 0, 256)
	genesis := palcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
