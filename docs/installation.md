...
* Install the MSI available at: [btcd windows installer](https://github.com/palcoin-project/btcd/releases)
...
* [Using bootstrap.dat](https://github.com/palcoin-project/palcd/blob/master/docs/configuration.md#using-bootstrapdat)
