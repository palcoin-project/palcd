...
btcd has a number of [configuration](https://pkg.go.dev/github.com/palcoin-project/palcd)
...
```
gencerts --host=myhostname.example.com --directory=/home/me/.palcd/
```
...
```bat
"%PROGRAMFILES%\Palcd Suite\Palcd\addblock" -i C:\Path\To\bootstrap.dat
```
