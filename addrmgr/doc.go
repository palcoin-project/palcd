...
/*
Package addrmgr implements concurrency safe Palcoin address manager.

Address Manager Overview

In order maintain the peer-to-peer Palcoin network, there needs to be a source
of addresses to connect to as nodes come and go.  The Palcoin protocol provides
