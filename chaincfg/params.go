...
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "1948", //8333
	DNSSeeds: []DNSSeed{
		{"seed1.palcoin.net", true},
	},
	...
	PowLimitBits:             0x2000001f,
	BIP0034Height:            1, // always available
	BIP0065Height:            1, // always available
	BIP0066Height:            1, // always available
	CoinbaseMaturity:         100,
	SubsidyReductionInterval: 600000,             // halve every
	TargetTimespan:           time.Hour * 24 * 2, // recalculate difficulty every
	TargetTimePerBlock:       time.Minute * 4,
...
var RegressionNetParams = Params{
	...
	MinDiffReductionTime:     time.Minute * 4, // TargetTimePerBlock * 2
	GenerateSupported:        true,
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "bcr", // always bcrt for reg test net
...
var TestNet3Params = Params{
	Name:        "testnet3",
	Net:         wire.TestNet3,
	DefaultPort: "11948", //18333
	DNSSeeds: []DNSSeed{
		{"seed-test1.palcoin.net", true},
	},
