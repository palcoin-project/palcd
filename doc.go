...
~/.palcd/palcd.conf on POSIX-style operating systems and %LOCALAPPDATA%\btcd\palcd.conf
...
Application Options:
  ...
  -d, --debuglevel=           Logging level for all subsystems {trace, debug,
      ...
      --listen=               Add an interface/port to listen for connections
                              (default all interfaces port: 1948, testnet:
                              11948, signet: 31948)
      ...
      --rpclisten=            Add an interface/port to listen for RPC
                              connections (default port: 1967, testnet: 11967)
